    ...
    return [
        Tool(
            ...
            description=(
                ...
                "(Home Assistant, Hue, OBS, Spotify, Wave Link, etc.): each hit's "
                "'action' field preserves plugin Settings — pass it as the button's "
                "'action' on write_page (optionally override title/icon_path). Filters: "
